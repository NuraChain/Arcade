...
export const routes: PageRoute[] = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'games/:slug/create', lazy: () => import('./pages/app/create-game.page.azeroth'), meta: defineMeta({ title: 'create.title', tab: 'games', parent: '/app/games/:slug' }) },
            ...
            { path: 'chats', lazy: () => import('./pages/app/chats.page.azeroth'), meta: defineMeta({ title: 'app.nav.chats', tab: 'chats', messenger: true }) },
            { path: 'chats/:id', lazy: () => import('./pages/app/chat.page.azeroth'), meta: defineMeta({ tab: 'chats', parent: '/app/chats', immersive: true, messenger: true }) },
